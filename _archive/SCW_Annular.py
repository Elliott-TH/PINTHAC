...
def qp_new(Property, Tm_i, Tm_o, p, qp_i, qp_o, qp_total, C0_Guess, inputs):
    ...
    htc_conv_o = htc_scw(Property, Tm_i, qp_i, p, G_i, d_i) * Psi#Shen(Tm_o, G_o, Dh)*Psi
...
# =============================================================================
def run_SCA(inputs, pval, Tscw_in, TPb_in, q0, L=3.0, n=400, scw_table=None):
    ...
    hin_Pb = Property(['T', Tscw_in], 'h')#LM.Lead.h(TPb_in)
...
if __name__ == '__main__':
    ...
    inputs = {
        "pitch":  0.06, "rco_i": 0.002, "rco_o": 0.025,
        "tc_i":   0.0007, "tc_o": 0.0007, "delta": 5e-4,
        "kc_i":   24, "kc_o": 24, "G_i": 1000, "G_o": 1000,
    }

    t0 = time.time()
    out = run_SCA(inputs, pval=25, Tscw_in=300+273.15, TPb_in=300+273.15, q0=25e3, L=3, n=400)

"""NumPy/PyTorch dispatch for property models and correlations.

Tensor inputs select PyTorch to preserve device placement and autograd;
other inputs select NumPy.
"""
import numpy as np

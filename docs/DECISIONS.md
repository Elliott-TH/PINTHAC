...
| **Scope: D9 steel** | No good models exist; leave it. | ~~`MatMod.D9_SS` stays an unimplemented stub.~~ **Superseded by the round-2 decision below**, which adds the two constant properties Hughes supplies. The point stands for any *temperature-dependent* D9 model: none is available and none should be invented. |
